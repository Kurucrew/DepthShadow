...
namespace KBASIS_EX
{
	...
	public:
		...
		KRay() noexcept : position(0, 0, 0), direction(0, 0, 1) {}
		KRay(const KVector3& pos, const KVector3& dir) : position(pos), direction(dir) {}

		KRay(const KRay&) = default;
		KRay& operator=(const KRay&) = default;

		KRay(KRay&&) = default;
		KRay& operator=(KRay&&) = default;

		// Comparison operators
		bool operator == (const KRay& r) const;
		bool operator != (const KRay& r) const;
	...
	public:
		...
		XM_CONSTEXPR KViewport(float ix, float iy, float iw, float ih, float iminz = 0.f, float imaxz = 1.f) :
			x(ix), y(iy), width(iw), height(ih), minDepth(iminz), maxDepth(imaxz) {}
		explicit KViewport(const RECT& rct) :
		...
		// Direct3D 11 interop
		explicit KViewport(const D3D11_VIEWPORT& vp) :
		...
		KViewport& operator= (const D3D11_VIEWPORT& vp);
#endif

#if defined(__d3d12_h__) || defined(__d3d12_x_h__)
		// Direct3D 12 interop
		explicit KViewport(const D3D12_VIEWPORT& vp) :
			x(vp.TopLeftX), y(vp.TopLeftY),
			width(vp.Width), height(vp.Height),
			minDepth(vp.MinDepth), maxDepth(vp.MaxDepth) {}
		...
		KViewport& operator= (const D3D12_VIEWPORT& vp);
#endif

		KViewport(const KViewport&) = default;
		KViewport& operator=(const KViewport&) = default;

		KViewport(KViewport&&) = default;
		KViewport& operator=(KViewport&&) = default;

		// Comparison operators
		bool operator == (const KViewport& vp) const;
		bool operator != (const KViewport& vp) const;

		// Assignment operators
		KViewport& operator= (const RECT& rct);

		// KViewport operations
	...
	static KMatrix* D3DXMatrixIdentity(KMatrix* pOut)
	{
		XMStoreFloat4x4(pOut, XMMatrixIdentity());
		return pOut;
	}
	static KMatrix* D3DXMatrixRotationQuaternion(KMatrix* pOut, CONST KQuaternion* pQ)
	{
	...
	static float D3DXMatrixDeterminant(CONST KMatrix* pM) {
		return pM->Determinant();
	}

	static HRESULT D3DXMatrixDecompose(KVector3* pOutScale, KQuaternion* pOutRotation,
	...
	static KMatrix* D3DXMatrixTranspose(KMatrix* pOut, CONST KMatrix* pM) {
	...
	static KMatrix* D3DXMatrixMultiply(KMatrix* pOut, CONST KMatrix* pM1, CONST KMatrix* pM2) {
		*pOut = (*pM1) * (*pM2);
		return pOut;
	}

	// Matrix multiplication, followed by a transpose. (Out = T(M1 * M2))
	static KMatrix* D3DXMatrixMultiplyTranspose(KMatrix* pOut, CONST KMatrix* pM1, CONST KMatrix* pM2) {
	...
	// is non-NULL.
	static KMatrix* D3DXMatrixInverse(KMatrix* pOut, float* pDeterminant, CONST KMatrix* pM) {
		pM->Invert(*pOut);
	...
	static KMatrix* D3DXMatrixScaling(KMatrix* pOut, float sx, float sy, float sz) {
		*pOut = KMatrix::CreateScale(sx, sy, sz);
		return pOut;
	}

	// Build a matrix which translates by (x, y, z)
	static KMatrix* D3DXMatrixTranslation(KMatrix* pOut, float x, float y, float z) {
		*pOut = KMatrix::CreateTranslation(x, y, z);
		return pOut;
	}

	// Build a matrix which rotates around the X axis
	static KMatrix* D3DXMatrixRotationX(KMatrix* pOut, float Angle) {
		*pOut = KMatrix::CreateRotationX(Angle);
		return pOut;
	}

	// Build a matrix which rotates around the Y axis
	static KMatrix* D3DXMatrixRotationY(KMatrix* pOut, float Angle) {
		*pOut = KMatrix::CreateRotationY(Angle);
		return pOut;
	}

	// Build a matrix which rotates around the Z axis
	static KMatrix* D3DXMatrixRotationZ(KMatrix* pOut, float Angle) {
		*pOut = KMatrix::CreateRotationZ(Angle);
		return pOut;
	}

	// Build a matrix which rotates around an arbitrary axis
	static KMatrix* D3DXMatrixRotationAxis(KMatrix* pOut, CONST KVector3* pV, float Angle) {
	...
	static KMatrix* D3DXMatrixRotationYawPitchRoll(KMatrix* pOut, float Yaw, float Pitch, float Roll) {
	...
	static KMatrix* D3DXMatrixTransformation(KMatrix* pOut, CONST KVector3* pScalingCenter,
	...
	// Mout = Msc-1 * Msr-1 * Ms * Msr * Msc * Mrc-1 * Mr * Mrc * Mt
	static KMatrix* D3DXMatrixTransformation2D(KMatrix* pOut, CONST KVector2* pScalingCenter,
	...
	static KMatrix* D3DXMatrixAffineTransformation(KMatrix* pOut, float Scaling, CONST KVector3* pRotationCenter,
	...
	// Mout = Ms * Mrc-1 * Mr * Mrc * Mt
	static KMatrix* D3DXMatrixAffineTransformation2D(KMatrix* pOut, float Scaling, CONST KVector2* pRotationCenter,
		float Rotation, CONST KVector2* pTranslation) {
		return pOut;
	}

	// Build a lookat matrix. (right-handed)
	static KMatrix* D3DXMatrixLookAtRH(KMatrix* pOut, CONST KVector3* pEye, CONST KVector3* pAt, CONST KVector3* pUp) {
		return pOut;
	}

	// Build a lookat matrix. (left-handed)
	static KMatrix* D3DXMatrixLookAtLH(KMatrix* pOut, CONST KVector3* pEye, CONST KVector3* pAt, CONST KVector3* pUp) {
		*pOut = KMatrix::CreateLookAt(*pEye, *pAt, *pUp);
		return pOut;
	}

	// Build a perspective projection matrix. (right-handed)
	static KMatrix* D3DXMatrixPerspectiveRH(KMatrix* pOut, float w, float h, float zn, float zf) {
		return pOut;
	}

	// Build a perspective projection matrix. (left-handed)
	static KMatrix* D3DXMatrixPerspectiveLH(KMatrix* pOut, float w, float h, float zn, float zf) {
		*pOut = KMatrix::CreatePerspective(w, h, zn, zf);
		return pOut;
	}

	// Build a perspective projection matrix. (right-handed)
	static KMatrix* D3DXMatrixPerspectiveFovRH(KMatrix* pOut, float fovy, float Aspect, float zn, float zf)
	{
		using namespace DirectX;
	...
	// Build a perspective projection matrix. (left-handed)
	static KMatrix* D3DXMatrixPerspectiveFovLH(KMatrix* pOut, float fovy, float Aspect, float zn, float zf)
	{
		using namespace DirectX;
	...
	// Build a perspective projection matrix. (right-handed)
	static KMatrix* D3DXMatrixPerspectiveOffCenterRH(KMatrix* pOut, float l, float r, float b, float t, float zn, float zf) {
		return pOut;
	}

	// Build a perspective projection matrix. (left-handed)
	static KMatrix* D3DXMatrixPerspectiveOffCenterLH(KMatrix* pOut, float l, float r, float b, float t, float zn, float zf) {
		*pOut = KMatrix::CreatePerspectiveOffCenter(l, r, b, t, zn, zf);
		return pOut;
	}

	// Build an ortho projection matrix. (right-handed)
	static KMatrix* D3DXMatrixOrthoRH(KMatrix* pOut, float w, float h, float zn, float zf) {
		return pOut;
	}

	// Build an ortho projection matrix. (left-handed)
	static KMatrix* D3DXMatrixOrthoLH(KMatrix* pOut, float w, float h, float zn, float zf) {
		*pOut = KMatrix::CreateOrthographic(w, h, zn, zf);
		return pOut;
	}

	// Build an ortho projection matrix. (right-handed)
	static KMatrix* D3DXMatrixOrthoOffCenterRH(KMatrix* pOut, float l, float r, float b, float t, float zn, float zf) {
		return pOut;
	}

	// Build an ortho projection matrix. (left-handed)
	static KMatrix* D3DXMatrixOrthoOffCenterLH(KMatrix* pOut, float l, float r, float b, float t, float zn, float zf) {
	...
	static KMatrix* D3DXMatrixShadow(KMatrix* pOut, CONST KVector4* pLight, CONST KPlane* pPlane)
	{
	...
	static KMatrix* D3DXMatrixReflect(KMatrix* pOut, CONST KPlane* pPlane) {
...
namespace std
{
	template<> struct less<KBASIS_EX::KRectangle>
	{
		bool operator()(const KBASIS_EX::KRectangle& r1, const KBASIS_EX::KRectangle& r2) const
		{
			return ((r1.x < r2.x)
				|| ((r1.x == r2.x) && (r1.y < r2.y))
	...
	template<> struct less<KBASIS_EX::KVector2>
	{
		bool operator()(const KBASIS_EX::KVector2& V1, const KBASIS_EX::KVector2& V2) const
		{
			return ((V1.x < V2.x) || ((V1.x == V2.x) && (V1.y < V2.y)));
		}
	};

	template<> struct less<KBASIS_EX::KVector3>
	{
		bool operator()(const KBASIS_EX::KVector3& V1, const KBASIS_EX::KVector3& V2) const
		{
			return ((V1.x < V2.x)
				|| ((V1.x == V2.x) && (V1.y < V2.y))
	...
	template<> struct less<KBASIS_EX::KVector4>
	{
		bool operator()(const KBASIS_EX::KVector4& V1, const KBASIS_EX::KVector4& V2) const
		{
			return ((V1.x < V2.x)
				|| ((V1.x == V2.x) && (V1.y < V2.y))
				|| ((V1.x == V2.x) && (V1.y == V2.y) && (V1.z < V2.z))
	...
	template<> struct less<KBASIS_EX::KMatrix>
	{
		bool operator()(const KBASIS_EX::KMatrix& M1, const KBASIS_EX::KMatrix& M2) const
		{
	...
	template<> struct less<KBASIS_EX::KPlane>
	{
		bool operator()(const KBASIS_EX::KPlane& P1, const KBASIS_EX::KPlane& P2) const
		{
			return ((P1.x < P2.x)
				|| ((P1.x == P2.x) && (P1.y < P2.y))
	...
	template<> struct less<KBASIS_EX::KQuaternion>
	{
		bool operator()(const KBASIS_EX::KQuaternion& Q1, const KBASIS_EX::KQuaternion& Q2) const
		{
			return ((Q1.x < Q2.x)
				|| ((Q1.x == Q2.x) && (Q1.y < Q2.y))
	...
	template<> struct less<KBASIS_EX::KColor>
	{
		bool operator()(const KBASIS_EX::KColor& C1, const KBASIS_EX::KColor& C2) const
		{
			return ((C1.x < C2.x)
				|| ((C1.x == C2.x) && (C1.y < C2.y))
	...
	template<> struct less<KBASIS_EX::KRay>
	{
		bool operator()(const KBASIS_EX::KRay& R1, const KBASIS_EX::KRay& R2) const
		{
	...
	template<> struct less<KBASIS_EX::KViewport>
	{
		bool operator()(const KBASIS_EX::KViewport& vp1, const KBASIS_EX::KViewport& vp2) const
		{
