...
ID3D11Texture2D* KViewDS::CreateTexture(UINT Width, UINT Height)
{
	HRESULT hr = S_OK;

	//텍스쳐 생성 : 깊이, 스텐실 값을 저장하는 버퍼용
...
HRESULT KViewDS::CreateDepthStencilView(UINT Width, UINT Height)
{
	HRESULT hr = S_OK;
