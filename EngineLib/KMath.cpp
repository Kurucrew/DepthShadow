...
namespace KBASIS_EX
{
	...
	****************************************************************************/
	...
	// Comparision operators
	//------------------------------------------------------------------------------
	bool KRay::operator == (const KRay& r) const
	{
		using namespace DirectX;
	...
	bool KRay::Intersects(const BoundingSphere& sphere, _Out_ float& Dist) const
	{
		return sphere.Intersects(position, direction, Dist);
	}

	bool KRay::Intersects(const BoundingBox& box, _Out_ float& Dist) const
	{
		return box.Intersects(position, direction, Dist);
	}

	bool KRay::Intersects(const KVector3& tri0, const KVector3& tri1, const KVector3& tri2, _Out_ float& Dist) const
	{
		return DirectX::TriangleTests::Intersects(position, direction, tri0, tri1, tri2, Dist);
	}

	bool KRay::Intersects(const KPlane& plane, _Out_ float& Dist) const
	{
		using namespace DirectX;
	...
	****************************************************************************/
	...
	bool KViewport::operator == (const KViewport& vp) const
	{
	...
	KViewport& KViewport::operator= (const RECT& rct)
	{
	...
	KViewport& KViewport::operator= (const D3D11_VIEWPORT& vp)
	{
	...
	KViewport& KViewport::operator= (const D3D12_VIEWPORT& vp)
	{
		x = vp.TopLeftX; y = vp.TopLeftY;
		width = vp.Width; height = vp.Height;
		minDepth = vp.MinDepth; maxDepth = vp.MaxDepth;
	...
	float KViewport::AspectRatio() const
	{
	...
	KVector3 KViewport::Project(const KVector3& p, const KMatrix& proj, const KMatrix& view, const KMatrix& world) const
	{
		using namespace DirectX;
	...
	void KViewport::Project(const KVector3& p, const KMatrix& proj, const KMatrix& view, const KMatrix& world, KVector3& result) const
	{
		using namespace DirectX;
		XMVECTOR v = XMLoadFloat3(&p);
		XMMATRIX projection = XMLoadFloat4x4(&proj);
	...
	KVector3 KViewport::Unproject(const KVector3& p, const KMatrix& proj, const KMatrix& view, const KMatrix& world) const
	{
		using namespace DirectX;
		XMVECTOR v = XMLoadFloat3(&p);
		XMMATRIX projection = XMLoadFloat4x4(&proj);
	...
	void KViewport::Unproject(const KVector3& p, const KMatrix& proj, const KMatrix& view, const KMatrix& world, KVector3& result) const
	{
		using namespace DirectX;
		XMVECTOR v = XMLoadFloat3(&p);
		XMMATRIX projection = XMLoadFloat4x4(&proj);
